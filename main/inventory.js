...
export const FIRES_ITEM_ID = "fires-item";
export const KETCHUP_ITEM_ID = "ketchup-item";
...
const INVENTORY_ITEM_DEFINITIONS = {
  ...
  [FIRES_ITEM_ID]: {
    id: FIRES_ITEM_ID,
    labelKey: "action_fires_item",
    iconId: FIRES_ITEM_ID,
    inspectId: FIRES_ITEM_ID,
    stackSize: 5
  },
  [KETCHUP_ITEM_ID]: {
    id: KETCHUP_ITEM_ID,
    labelKey: "action_ketchup_item",
    iconId: KETCHUP_ITEM_ID,
    inspectId: KETCHUP_ITEM_ID,
    stackSize: 2
  }
};
